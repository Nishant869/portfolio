...
export class ProjectComponent {
  ...
  readonly projects:IProject[] = [
    ...
    },
    {
      ...
      skillsUsed:[Skills.ANGULAR,Skills.ORACLE_DB,Skills.NODE,Skills.BLOCKCHAIN]
    },
    {
      ...
      skillsUsed:[Skills.ANGULAR,Skills.ORACLE_DB,Skills.NODE,Skills.BLOCKCHAIN,Skills.GOLDEN_GATE]
    },
    {
      projectHeading:`AERO`,
      teamSize:4,
      description:`POAP based event management portal.`,
      skillsUsed:[Skills.REACT,Skills.NODE,Skills.BLOCKCHAIN,Skills.ORACLE_DB]
    },
    {
